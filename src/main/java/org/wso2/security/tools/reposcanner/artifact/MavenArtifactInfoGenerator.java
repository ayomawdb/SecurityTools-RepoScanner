...
public class MavenArtifactInfoGenerator implements ArtifactInfoGenerator {
    ...
    @Override
    public RepoArtifact getArtifact(String consoleTag, File baseFolder, File configFile) throws MavenInvocationException {
        ...
        if (id != null && id.split(":").length == 4) {
            ...
            //Repo will be set by the caller
            RepoArtifact mavenInfo = new RepoArtifact(null, path, id, finalName);
            return mavenInfo;
        } else {
